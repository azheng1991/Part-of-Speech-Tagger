...
Alternatively, you can download a copy of the AIND project materials here and then run a Jupyter server locally on your machine to complete Project 4: part of speech tagging. (NOTE: these steps are not required if you are using the project Workspace.)

Open a terminal and activate the AIND conda environment (refer to the instructions in the intro lesson). (NOTE: the project repository includes a conda environment specification file called "hmm-tagger.yaml", but you do not need this file to complete the project if you already have the aind conda environment installed from earlier assignments.)

Clone the AIND repo:

$ git clone https://github.com/udacity/artificial-intelligence
Switch to the project folder and launch a Jupyter server:
